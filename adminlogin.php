...
<div class="header">
	 <div class="container">
		 ...
		 <div class="top-menu">
			 ...
			 <li  class="active"><a href="adminlogin.php"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>Login</a></li>
...
<center>
		...
		<!--===============================================================================================-->
					...
					<br/>
					<br/>
					<form class="login100-form validate-form" method="POST" action="adminloginp.php">	
...
<?php
	...
	// $result=mysql_query("select * from admin_reg where email='".$email."',password='".$password."'",$con);
