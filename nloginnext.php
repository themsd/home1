	 ...
	 <div class="container">
		 ...
		 <div class="top-menu">
			...
			<!-- <li><a href="reg.php"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>Registration</a></li> -->
			 <li  class="active"><a href="nloginnext.php"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>Login</a></li>
...
<html>
<head>
<title>Needy REQUEST ACCPET OR DENY PAGE</title>
</head>
<body>
<center>
<br/>
<br/>
<h3>Waiting For Response we send message about your payment</h3>
<h2></h2> 
</center>
</body>