...
<div class="header">
	 <div class="container">
		 ...
		 <div class="top-menu">
			...
			<!-- <li><a href="dreg.php"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>Registration</a></li> -->
			 <li  class="active"><a href="donorlogin.php"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>Login</a></li>
...
<center>
		...
		<!--===============================================================================================-->
				...
				<!-- <form class="login100-form validate-form" method="POST" action="payment.html"> -->
				<form class="login100-form validate-form" method="POST" action="dloginp.php">
